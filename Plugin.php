...
class WeChatShare_Plugin  implements Typecho_Plugin_Interface
{
    ...
    public static function render()
    {
		...
		$data = '<style></style><form id="wx_share" ><fieldset style="background-color:#FFF;border:0px;margin:0px;"><b style="display:block; margin-top:10px; margin-left:18px;">微信分享</b><ol style="list-style-type:none;"><li style="padding-bottom: 5px;"><label for="wx_title">标题：</label><input style="width: 90%" type="text" class="wx_title" value="'.$wx_title.'" name="wx_title" ></li><li style="padding-bottom: 5px;margin-top:5px"><label for="wx_url">链接：</label><input type="text" style="width: 90%" value="'.$wx_url.'" name="wx_url"></li><li style="padding-bottom: 5px; display:block; margin-top:5px;"><span style="float:left" for="wx_describe">摘要：</span><textarea rows="4" class="wx_describe" name="wx_description" style="width: 90%"  >'.$wx_description.'</textarea></li><li style="padding-bottom: 5px;"><label for="wx_image">图标：</label><input type="text" class="wx_image"  value="'.$wx_image.'" style="width: 90%"  name="wx_image"></li></ol></fieldset><input type="hidden" name="cid" value="'.$match['1'].'"></form>';
